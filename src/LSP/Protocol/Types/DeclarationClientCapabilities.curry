...
instance Default DeclarationClientCapabilities where
  def =
    DeclarationClientCapabilities { declarationClientCapabilitiesDynamicRegistration = def
                                  , declarationClientCapabilitiesLinkSupport = def }
